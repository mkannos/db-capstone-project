...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `fk_EmployeeID` FOREIGN KEY (`EmployeeID`) REFERENCES `employees` (`EmployeeID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `menu` (
  `MenuID` int NOT NULL,
  `MenuItemsIS` int NOT NULL,
  `Cusine` varchar(45) NOT NULL,
  PRIMARY KEY (`MenuID`),
  KEY `fk_MenuItems_idx` (`MenuItemsIS`),
  CONSTRAINT `fk_MenuItems` FOREIGN KEY (`MenuItemsIS`) REFERENCES `menuitems` (`MenuItemsID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menuitems` (
  ...
  `MenuItemscol` varchar(45) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_Orders` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-04 20:13:56
